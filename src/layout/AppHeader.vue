                        ...
                        <router-link to="/searchObj"
                           class="media d-flex align-items-center">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="description d-none d-md-inline-block mb-0">Start to get the list of conferences, authors, keywords and afflications which satisfy you.</p>
                            </div>
                        </router-link>
                        <router-link to="/searchPaper"
                           class="media d-flex align-items-center">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="description d-none d-md-inline-block mb-0">Get all the papers by paper name, author name, afflication or time according to your input.</p>
                            </div>
                        </router-link>
                    </div>
                </base-dropdown>
